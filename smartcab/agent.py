...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        waypoint = list([])
        waypoint.append(self.planner.next_waypoint()) # The next waypoint rtype string
        inputs = self.env.sense(self)           # Visual input - intersection light and traffic rtype dict
    ...
    def choose_action(self, state):
        ...
        if (self.learning == False):
            print "Learning set to False, choose random action"
            action = random.choice(self.valid_actions)
            print "chosen action is", action
        else:
            print "Learning=True, choose random action if epsilon > randomNumber"
